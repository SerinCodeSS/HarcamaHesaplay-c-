...
let toplam = 0;
//Her eklenen ürünle birlikte toplam fiyatın güncellenmesi toplama fonksiyonu
...
function addExpense(e) {
  ...
  //Inputların içeriğini işlem bittikten sonra temizleme
  harcamaInput.value = "";
  fiyatInput.value = "";
}
...
function handleClick(e) {
  ...
  if (tiklanilanEleman.id === "remove") {
    ...
    //bir elemanın bir üst kapsayıcı yapsını almak için parentElement kullanılır
